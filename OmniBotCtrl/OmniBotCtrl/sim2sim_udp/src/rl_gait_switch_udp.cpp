...
{   
    ...
    bool success1 = onnx_model_tort.init("/home/bianbu/bipedal-robot-sim/riscv/bipedal-sim-udp/Model/Trot/model.onnx", 39, 390, 10);
    
    printf("开始初始化ONNX_STAND模型...\n");
    bool success2 = onnx_model_stand.init("/home/bianbu/bipedal-robot-sim/riscv/bipedal-sim-udp/Model/Stand/model.onnx", 39, 390, 10);
